...
```{r data visualization, fig.width = 12, fig.height = 5, message=FALSE}
...
# Graph depicting vocabulary data set distributions
...
PlotMSTTR <- ggplot(stats_per_doc,
...
grid.arrange(PlotFreq, PlotMSTTR, ncol = 2)
